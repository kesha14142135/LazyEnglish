...
public class SwipeStackLearnLanguageAdapter extends ArrayAdapter<Word> {

    private Context mContext;
    private int[] mColors;

    public SwipeStackLearnLanguageAdapter(Context context) {
        super(context, 0);
        mContext = context;
    ...
    public View getView(int position, View contentView, ViewGroup parent) {
        ...
        holder.mTextViewHint.setOnClickListener(view ->
            holder.mTextViewHint.setText(word.getWordRus()));
        holder.mButtonSpeech.setOnClickListener(view ->
            Speech.getInstance().say(word.getWordEng()));
    ...
    private static class ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            mTextViewTranscription = view.findViewById(R.id.text_view_transcription);
